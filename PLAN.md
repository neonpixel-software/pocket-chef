...
- [ ] **7.1 String Catalog + automatic UI string resolution** — `Localizable.xcstrings` covering every user-facing UI string (51 keys across list/form/detail/capture screens), translated to Spanish, French, German, and Dutch alongside the English base.
