...
- [x] **7.3 View-model error messages localized** — the 3 capture-failure messages in `RecipeCaptureViewModel`/`RecipeURLCaptureViewModel` resolve via the same String Catalog.
