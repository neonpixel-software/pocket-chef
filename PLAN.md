...
- [x] **8.1 API scaffold + `DensityEntry` model** — new .NET project (ingredient name → grams-per-cup, since changed to grams per millilitre), basic persistence. PostgreSQL chosen (via Podman), not SQLite.
